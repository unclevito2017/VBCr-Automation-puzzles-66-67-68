...
def load_checkpoint():
    if os.path.exists('checkpoint.pkl'):
        ...
        return '40000000000000000', '40010000000000000'
...
def run_vbcr(start_keyspace, end_keyspace):
    ...
    command = f'VBCr.exe -t 0 -gpu -gpuId 0 -begr {start_keyspace} -endr {end_keyspace} -o {output_filename} -drk 1 -dis 1 -r 70000 -c 1BY8GQbn'
